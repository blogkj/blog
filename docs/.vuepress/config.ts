  ...
  themeConfig: {
    ...
    nav: [
      { text: '首页', link: '/' },
      {
        ...
        link: '/kernel/',
        items: [
          { text: '内核第一篇文章', link: '/pages/83d5df/' },
          { text: '内核第一篇文章', link: '/pages/52da1b/' },
        ],
      },
      {
        text: 'audio',
        link: '/audio/',
        items: [
          { text: 'audio第一篇文章', link: '/pages/bbdb65/' },
          { text: 'audio第一篇文章', link: '/pages/ca4899/' },
        ],
      },
      {
        text: '前端',
    ...
    author: {
      name: 'zhouzichun', // 必需
      link: 'https://github.com/blogkj', // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:zhouzichunX@gmail.com',
        },
        {
  ...
  plugins: <UserPlugins>[
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: '77741a52b8b118154c1b',
          clientSecret: '00653c1f0cd6adfc525cefb3bd4a4d9d1b13a27f',
          repo: 'blogtalk', // GitHub 仓库
          owner: 'blogkj', // GitHub仓库所有者
          admin: ['blogkj'], // 对仓库有写权限的人
